...
public:
    ...
    inline void NOP(){reg->Add_PC(1);}
    
    inline void LD_r1_r2(e_registers e_reg1, e_registers e_reg2)
    {
        BYTE length = 1;
    ...
    inline void LD_A_n(e_registers place)
    {
    ...
    inline void LD_n_A(e_registers place)
    {
    ...
    inline void CP_n(e_registers place)
    {
        BYTE value;
        BYTE length = 1;
    ...
    inline void LD_n_nn(e_registers place)
    {
    ...
    inline void JR_CC_n(e_registers flag, BYTE value2check)
    {
    ...
    inline void CALL_cc_nn(e_registers flag, BYTE value2check)
    {
        if (reg->Get_Flag(flag) == value2check)
        {
            CALL_nn();
    ...
    inline void SUB_n(e_registers place)
    {
        int value, length = 1;
    ...
    inline void ADD_A_n(e_registers place)
    {
        int value, length = 1;
        BYTE valueReg;
    ...
    inline void ADC_A_n(e_registers lugar)
    {
        int value, length = 1;
        BYTE valueReg;
    ...
    inline void INC_n(e_registers place)
    {
        BYTE value;
    ...
    inline void ADD_HL_n(e_registers place)
    {
        WORD value, hl;
    ...
    inline void RLC_n(e_registers place)
    {
        BYTE bit7, value;
    ...
    inline void INC_nn(e_registers lugar)
    {
    ...
    inline void DEC_n(e_registers place)
    {
        BYTE value;
    ...
    inline void DEC_nn(e_registers lugar)
    {
        reg->Set_Reg(lugar, reg->Get_Reg(lugar) - 1);
        reg->Add_PC(1);
    }
    
    inline void OR_n(e_registers lugar)
    {
        BYTE longitud = 1;
        BYTE value;
    ...
    inline void XOR_n(e_registers lugar)
    {
        BYTE longitud = 1;
        BYTE value;
    ...
    inline void RET_cc(e_registers flag, BYTE value2check)
    {
        reg->Add_PC(1);
        if (reg->Get_Flag(flag) == value2check)
        {
    ...
    inline void LD_nn_n(e_registers lugar)
    {
    ...
    inline void SET_b_r(BYTE bit, e_registers place)
    {
        if (place == c_HL)
    ...
    inline void BIT_b_r(BYTE bit, e_registers lugar)
    {
        BYTE value;
    ...
    inline void RES_b_r(BYTE bit, e_registers lugar)
    {
        if (lugar == c_HL)
            mem->MemW(reg->Get_HL(), mem->MemR(reg->Get_HL()) & ~(1 << bit));
        else
    ...
    inline void SBC_A(e_registers place)
    {
        WORD value;
        BYTE result;
        int sum;
    ...
    inline void AND(e_registers lugar)
    {
        BYTE longitud = 1;
    ...
    inline void SLA_n(e_registers place)
    {
        BYTE bit7, value;
    ...
    inline void SRA_n(e_registers lugar)
    {
    ...
    inline void SRL_n(e_registers place)
    {
        BYTE bit0, value;
    ...
    inline void SWAP(e_registers place)
    {
        BYTE value;
    ...
    inline void PUSH_nn(e_registers lugar)
    {
        reg->Add_SP(-1);
    ...
    inline void POP_nn(e_registers lugar)
    {
    ...
    inline void JP_cc_nn(e_registers flag, BYTE value2check)
    {
        WORD nn;
    ...
    inline void RL_n(e_registers place)
    {
        BYTE oldBit7, value;
    ...
    inline void RR_n(e_registers place)
    {
        BYTE bit0, value;
    ...
    inline void RRC_n(e_registers place)
    {
        BYTE bit0, value;
